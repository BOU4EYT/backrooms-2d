...
def draw_flashlight_cone(visibility, scr_px, scr_py):
    ...
    for step in reversed(range(1, FLASHLIGHT_SOFTNESS_STEPS + 1)):
        ...
        current_length = cone_length * ratio + random.randint(-FLASHLIGHT_JITTER_LENGTH, FLASHLIGHT_JITTER_LENGTH)
        half_width = (FLASHLIGHT_CONE_WIDTH / 2) * ratio + random.randint(-FLASHLIGHT_JITTER_WIDTH, FLASHLIGHT_JITTER_WIDTH)
